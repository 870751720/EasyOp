...
""",
    ...
    # Python roots for SWIG bindings
    if args.python64_root:
        env["PYTHON64_ROOT"] = str(resolve_path(project_dir, args.python64_root))
    if args.python32_root:
        env["PYTHON32_ROOT"] = str(resolve_path(project_dir, args.python32_root))
